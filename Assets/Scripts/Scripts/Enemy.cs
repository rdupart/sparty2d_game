...
public class Enemy : MonoBehaviour {
	...
	void Awake() {
		...
		if (_rigidbody==null) // if Rigidbody is missing
			Debug.LogWarning("Rigidbody2D component missing from this gameobject");
		
		_animator = GetComponent<Animator>();
		if (_animator==null) // if Animator is missing
			Debug.LogWarning("Animator component missing from this gameobject");
		...
		if (stunnedCheck==null) {
			Debug.LogWarning("stunnedCheck child gameobject needs to be setup on the enemy");
		}
